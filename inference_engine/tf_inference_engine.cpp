...
///
#include "inference_engine/inference_engine/tf_inference_engine.h"
...
TFInferenceEngine::TFInferenceEngine() : TFInferenceEngine{"inference_engine:5stems"} {}
...
Waveforms TFInferenceEngine::InvokeInference() const
{
    ...
    INFERENCE_ENGINE_LOG(INFO) << "Successfully received split " << outputs.size() << " waves.";
